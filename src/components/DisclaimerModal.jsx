    ...
    <div style={{
      ...
      <div className="glass-panel animate-fade-in" style={{
        ...
        <div style={{ fontSize: '0.88rem', color: 'var(--text-primary)', lineHeight: '1.6', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <p>
            <strong>kochi.metro.org.in</strong> is an independent commuter guide and is not affiliated with, endorsed by, or connected to Kochi Metro Rail Limited (KMRL), or any government agency.
          </p>
        </div>
      </div>
    </div>
