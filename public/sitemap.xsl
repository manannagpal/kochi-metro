  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        ...
        <meta charset="UTF-8" />
        <link rel="icon" type="image/svg+xml" href="https://kochi.metro.org.in/favicon.svg?v=2026.8" />
        <link rel="icon" type="image/png" sizes="48x48" href="https://kochi.metro.org.in/favicon-48x48.png?v=2026.8" />
        <link rel="shortcut icon" href="https://kochi.metro.org.in/favicon.ico?v=2026.8" />
        <style>
